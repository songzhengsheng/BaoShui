...
namespace NFine.Code.Datatable
{
    public static class DataTableExtensions2
    {
        ...
        /// <returns></returns>  
        public static System.Data.DataTable ToDataTable<T>(this IEnumerable<T> list)
        {
        ...
        /// <returns></returns>  
        public static System.Data.DataTable ToDataTableTow(IList list)
        {
