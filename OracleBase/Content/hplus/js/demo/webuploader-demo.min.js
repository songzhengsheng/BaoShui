jQuery(function () {
    ...
    function t(e) {
        ...
        if (e !== k) {
            switch (c.removeClass("state-" + k), c.addClass("state-" + e), k = e) {
                ...
                case "finish":
                    a = n.getStats(),
                        a.successNum ,alert("上传成功"),location.reload()
            }
            i()
        }
    }
    ...
    n = WebUploader.create({
        ...
        disableGlobalDnd: !0,
        chunked: !0,
        formData: { 'CONTRACT_Guid': $('#CONTRACT_Guid').val(), },
        server: "/Contract/WebuploaderUpLoadProcess",
        fileNumLimit: 300,
        ...
        //n.uploadBeforeSend = function (obj, data) { //传入表单参数
        //    data = $.extend(data, {
        //        "CONTRACT_Guid": $("#CONTRACT_Guid").val(),
